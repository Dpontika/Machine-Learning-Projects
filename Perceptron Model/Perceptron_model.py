...
def perceptron(x, t, max_epoch, beta):
    """
    ...
    epochs_used: number of epochs actually used
    
    """
    
    # Initialize random weights
    w = np.random.randn(5)  # Small random values
    ...
    for epoch in range(max_epoch):
        ...
        # Stop if no weights were changed (convergence)
...
beta = float(input("Enter learning rate (beta): "))
